...
import { Pin, Trash2, X, ChevronDown, Palette, Tag } from "lucide-react";
              ...
              <AnimatePresence>
                {showColorPicker && (
                  <motion.div
                    ...
                    className="absolute w-100  top-0 left-10  bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 p-2 z-10"
                  >
                    <div className="flex gap-2">
                      {colorOptions.map((option) => (
                        <motion.button
                          ...
                          className={`w-6 h-6 rounded-full ${option.color} ${option.border} border-4 shadow-lg transition-transform`}
                          title={option.label}
                        />
                      ))}
                    </div>
